    ...
    public function index()
    {
        $guides = [
            ...
            [
                ...
                'category' => 'Pembayaran',
                'content'  => "1. Masuk ke menu 'Tagihan'\n2. Pilih tagihan yang ingin dibayar\n3. Klik 'Bayar Sekarang'\n4. Bayar via Midtrans (kartu, VA, QRIS, e-wallet) atau upload bukti transfer manual\n5. Untuk pembayaran Midtrans, status akan otomatis confirmated begitu pembayaran berhasil — tidak perlu menunggu admin",
                'order'    => 2,
            ],
            [
                'id'       => 3,
