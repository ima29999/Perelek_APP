...
class AuthController extends Controller
{
    ...
    // -------------------------------------------------------------------------
    // Helper - Memastikan Format Data User Sinkron di Semua Endpoint Auth
    // -------------------------------------------------------------------------
    private function userResource(User $user): array
    {
        return [
            ...
            'rt_rw'         => $user->rt_rw,
            // Perbaikan rute bypass untuk profile photo
            'profile_photo' => $user->profile_photo
                ? url('api/profile-photo/' . $user->profile_photo)
                : null,
            // Menyisipkan ktp_photo jika sewaktu-waktu dibutuhkan Flutter
