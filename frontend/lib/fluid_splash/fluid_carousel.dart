...
class FluidCarousel extends StatefulWidget {
  ...
  /// Dipanggil setiap kali halaman aktif berubah (setelah swipe selesai).
  /// Nilainya sudah di-mod dengan jumlah children, jadi selalu antara
  /// 0 .. children.length - 1.
...
class FluidCarouselState extends State<FluidCarousel>
  ...
  bool _isSwipeComplete(double dx, double width) {
    ...
    if (ratio > 0.8 && availW / width > 0.5) {
      ...
      // Halaman baru sudah "terkunci" di sini -> kabari parent.
      widget.onIndexChanged?.call(_dragIndex! % widget.children.length);
    }
