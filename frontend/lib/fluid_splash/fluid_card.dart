          ...
          children: <Widget>[
            Transform.translate(
              ...
              child: Transform(
                ...
                child: Image.asset(
                  'assets/fluid_splash/images/Bg-${widget.color}.png',
                  fit: BoxFit.cover,
                ),
              ),
            ),
                  ...
                  children: <Widget>[
                    ...
                    Expanded(
                      ...
                      child: Padding(
                        ...
                        child: Image.asset(
                          'assets/fluid_splash/images/Illustration-${widget.color}.png',
                          fit: BoxFit.contain,
                        ),
                      ),
                    ),
                    ...
                    SizedBox(
                      height: 14,
                      child: Image.asset('assets/fluid_splash/images/Slider-${widget.color}.png'),
                    ),
